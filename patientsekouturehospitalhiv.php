    ...
    <body>
        <div id="maindiv">
            ...
            <div id="middleeT">
                <br><br/>
                <center>
                    <h1>PATIENT DETAILS FOR HIV AIDS AT SEKOU TOURE HOSPITAL</h1>
                    <?php
                 $link=  mysqli_connect("localhost", "root", "");
mysqli_select_db($link, "afyacheck");
$query="select * from patientdetails where hospital='sekou toure hospital' AND district='ilemela' AND disease='hiv/aids'";
